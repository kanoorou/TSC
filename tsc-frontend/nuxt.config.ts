...
export default defineNuxtConfig({
  ...
  app: {
    head: {
      ...
      script: [{ tagPosition: 'bodyClose', src: '/assets/js/common.js' },{tagPosition: 'bodyClose', src:'https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js', integrity:'sha384-geWF76RCwLtnZ8qwWowPQNguL3RmwHVBC9FhGdlKrxdiJJigb/j/68SIy3Te4Bkz',crossorigin:'anonymous'}]
    } 
  }
