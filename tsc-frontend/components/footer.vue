...
<template>
    ...
    <nav id="footer-main" class="">
        <div class="row row-cols-2 row-cols-xl-4">
            <div class="col">
                <ul class="">
                    <li class="primary-link" ><a href="/">HOME</a></li>
                    <li><a href="/about">TSCとは？</a></li>
                    <li><a href="/contest/">コンテストに参加する</a></li>
                    <li><a href="/">コンテストの仕組み・ルール</a></li>
                </ul>  
            </div>
            <div class="col">
                <ul class="">
                    <li class="primary-link"><a href="/">コンテスト</a></li>
                    <li><a href="/contest/">コンテストに参加する</a></li>
                    <li><a href="/leaderboard/">ランキング</a></li>
                    <li><a href="/">過去のコンテスト</a></li>
                </ul>  
            </div>
            <div class="col">
                <ul class="">
                    <li class="primary-link"><a href="/">学習コンテンツ</a></li>
                    <li><a href="/">TSC反応ガイド</a></li>
            ...
            <div class="col">
                <ul class="">
                    <li class="primary-link"><a href="/">お問い合わせ</a></li>
    ...
    <div class="row" id="footer-bottom">
        <div class="d-none d-md-block col-md-4" id="footer-logo">
            <a href="/"><img src="/assets/img/footer-logo.png" id="footer-icon-img"></a>
        </div>
