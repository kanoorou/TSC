<div class="container-fluid">
    ...
    <div class="row" id="footer-bottom">
        <div class="d-none d-md-block col-md-4" id="footer-logo">
            <a href="/TSC/index.php"><img src="/TSC/assets/footer-logo.png" id="footer-icon-img"></a>
        </div>
        <div class="col-md-8 d-flex align-items-center">
            <h2>Total Synthesis Contest</h2>
        </div>
    </div>
    <button  type="button" data-mdb-button-init data-mdb-ripple-init class="btn btn-floating btn-lg" id="btn-back-to-top"></button>
</div>
